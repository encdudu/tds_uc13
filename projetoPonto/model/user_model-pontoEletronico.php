<?php
    ...
    require_once "../util/database-pontoEletronico.php";
...
class UserModelPontoEletronico {
    ...
    public function create($matricula, $tipo) {
        ...
        $sql = "INSERT INTO ponto (matricula, tipo) VALUES (:matricula, current_time(), :tipo)"; //: coloca " " e torna tudo dentro tipo uma string
